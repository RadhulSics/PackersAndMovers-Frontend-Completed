                        ...
                        <div className="col-lg-7" style={{ paddingTop: '2rem' }}>
                            <form onSubmit={updatefcn}>
                                <div className="row g-3">
                                    ...
                                    <div className="col-6">
                                        <input type='text' className="form-control bg-light border-0 px-4 py-3" placeholder="Reg No" style={{ height: '55px' }} value={value.regno} name="regno" onChange={changefn} id='regno' />
                                    </div>
                                    <div className="col-12">
